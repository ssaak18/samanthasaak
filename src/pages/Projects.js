  ...
  <section className="container mx-auto p-8">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 justify-items-center mt-6">
      ...
      <ProjectCard 
        ...
        description="Created as a way to display my projects, this website is an ongoing project!" 
      />
      <ProjectCard 
        title="Photo Editor & Auction Game" 
        image="/images/projects/dog.png" 
        description="I created a photo editor game in Java where users can edit their photographs with classic photo editing tools, such as tint or pixelate, and then sell their work in an auction-style game." 
      />
    </div>
  </section>
);
